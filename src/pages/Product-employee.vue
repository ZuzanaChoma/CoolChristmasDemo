<template>
  <div>
    ...
    <ul class="breadcrumbs">
      ...
      <li>
        <a href="/products-employee/">products</a>
      </li>
      <li>
        {{product_data.name}}
      </li>
      ...
      <div class="product-page-wrapper">
        <div class="product-wrapper">
          ...
          <div class="product-info">
            ...
            <div v-if="!chosenGift && giftAmount<1" class="action-button" @click="addItemToBasket(product_data.id)">Choose gift</div>
            <div v-if="chosenGift" class="action-button remove" @click="removeItemFromBasket(product_data.id)">Remove gift</div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    chosenGift(){
      var isChosen = this.$store.getters.giftItem.includes(this.product_id);
      return isChosen;
    },
    giftAmount(){
